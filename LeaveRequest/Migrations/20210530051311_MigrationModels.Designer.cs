...
namespace LeaveRequest.Migrations
{
    ...
    [Migration("20210530051311_MigrationModels")]
            ...
            modelBuilder.Entity("LeaveRequest.Models.RequestStatus", b =>
                {
                    ...
                    b.Property<int>("IdRequestS")
                        .HasColumnType("int");

                    b.Property<int?>("PersonNIK")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LeaveRequest.Models.Departement", b =>
                {
                    b.HasOne("LeaveRequest.Models.Person", "Person")
                        .WithOne("Departement")
                        .HasForeignKey("LeaveRequest.Models.Departement", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
